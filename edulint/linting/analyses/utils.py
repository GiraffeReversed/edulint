...
import operator
import sys
from typing import Union, List, Optional, Any, TypeVar, Generic, Iterable, Tuple, cast, Callable

from astroid import nodes, Uninferable
from astroid.const import Context
from pylint.checkers import utils  # type: ignore

from edulint.linting.analyses.var_events import VarEvent
...
# def is_builtin(node, function=None):
