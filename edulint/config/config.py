...
from edulint.config.config_translates import ConfigTranslations, get_config_translations
...
def get_config(filename: str, config_translates: ConfigTranslations = get_config_translations()) -> Config:
