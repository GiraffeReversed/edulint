...
@pytest.mark.parametrize("lines,expected_output", [
    ...
    ([  # 10
        ...
        '	while c:',
        '		for _ in range(5):',
        '			arr.append( list(map(f.readline().rstrip, arr)) )',
        '',
        'def normal(arr):',
        '	for _ in range(5):',
        '		arr.append( list(map(input, arr)) )',
    ], []),
    ([  # 11
        'input = None',
        'def text(arr, c):',
    ...
    ([  # 14
        'def text(arr, c):',
        '	while c:',
        '		for arr[0] in range(5):',
        '			arr.append( list(map(c, arr)) )',
        '',
        'def normal(arr, input):',
        '	for input in range(5):',
        '		arr.append( list(map(input, arr)) )',
...
@pytest.mark.parametrize("filename,expected_output", [
    ...
    ("ee99307f8b-p2_nested.py", []),
    ("cf_c_1451_15.py", []),
    ("cf_b_431_46.py", []),
    ("dc315e6c9e-hw5.py", []),
    ("ksi_15_363_609_be94.py", []),
    ("web_f73b15.py", []),
    ("cf_b_1163_30.py", []),
    ("ut_156_37_37-20.py", []),
])
