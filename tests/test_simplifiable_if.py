...
@pytest.mark.parametrize("lines,expected_output", [
    ([
        ...
        "t = x != y or ((x - y) if x > y else (y - x)) != 0 # I didn't allow if-exps in this checker",
    ], [
        lazy_problem().set_line(4)
...
@pytest.mark.parametrize("lines,expected_output", [
    ([
        ...
        lazy_problem().set_line(4)
        .set_text("The next 2 if statements after this one can be elif statements.")
    ]),
    ([
        "x = 1",
        "y = 2",
    ...
    ([
        ...
        lazy_problem().set_line(4)
        .set_text("The next 1 if statements after this one can be elif statements."),
    ]),
    ([  # I shouldn't split these, because this is also supposed to test how the checker
        # works with multiple `ifs` one after another.
        "x = 1",
        "y = 2",
        "",
        "if x > y:",
    ...
    ([
        ...
        "        b = True",
        "",
        "    if x <= y + 1: # here `b` can be True or False when x > y + 1",
        "        return",
        "",
        "if b:",
        "    x = y",
    ...
    ([
        ...
        "        b = True",
        "",
        "    if x <= y + 2: # note that this can be False only for `b = False`",
        "        return",
        "",
        "if b:",
        "    x = y",
